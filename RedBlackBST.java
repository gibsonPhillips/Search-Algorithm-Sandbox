...
// Copy To USERID.hw4 package. NOTE: ONLY MAKE CHANGES AT THE END OF THIS FILE (LINE 626 or so)
...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
	...
	public int heightDifference(Node node) {
		...
		int rightTarget = 0;
		if (node.left != null) {
			leftTarget = 1 + height(node.left);
		}
		if (node.right != null) {
			rightTarget = 1 + height(node.right);
		}
